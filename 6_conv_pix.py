...
def model(X, w1, w2, w3, w4, p_drop_conv, p_drop_hidden):
    print('model:X=%s,w1=%s,w2=%s,w3=%s,w4=%s' % (S(X), S(w1), S(w2), S(w3), S(w4)))
    ...
    print('model:pyx=%s,l1=%s,l2=%s,l3=%s,l4=%s' % (S(pyx), S(l1), S(l2), S(l3), S(l4)))
    return l1, l2, l3, l4, pyx

if True:
    x = np.eye(28)
    w1 = init_weights0(( 32,  1, 3, 3))
    w2 = init_weights0(( 64, 32, 3, 3))
    w3 = init_weights0((128, 64, 3, 3))
    w4 = init_weights0((128 * 3 * 3, 625))
    w_o = init_weights0((625, 10))
    X = T.ftensor4()
